...
//    private int footerViewType = R.layout.loading_layout;
...
//                            Log.i(mTag, "!!!!currentpage:" + currentPage);
            ...
            if (!loading) {
                ...
                loading = true;
                Logger.i(mTag, "request pageindex:" + currentPage + ",totalItemsCount:" + totalItemCount);
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
        ...
        if (onScrollListener != null) onScrollListener.onScrollStateChanged(recyclerView, newState);
    }
...
//        Log.i(mTag, "isFooterView:" + isFooterView);
    ...
    /**
     * an optional interface for the scrollListener methods
     */
